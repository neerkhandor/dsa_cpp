...
Node* insertIntoBST(Node* root, int data) {
        ...
        //not the first node 
		// agar structure mein pherphar karna ho to root->left= karke call karo
		// but agar normal traversal karna ho to sidha call karo
        if(root-> data > data) {
                //insert in left
                ...
                // insert into right
				// both condition are handled root->data <= data
...
//cout << "Request recieved for " >> root->data << " with target" << target << endl;
	if(root->data == target) {
		...
		//right jana chahiye deletion mein structure bogdega therefore ham root->right ke through call mar rahe hai
